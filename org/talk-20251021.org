...
* あらすじ -- 数理情報科学研究のための数理情報リテラシー [[file:../Maps/数理情報科学のための情報計算リテラシー.xmind][link]] [[shell:xmind ../Maps/数理情報科学のための情報計算リテラシー.xmind][cmd]]
...
[[file:~/COMM/Lects/science_and_computation/comp_and_cal/Maps/ICTの利用目的.xmind]]


本講では，理工学研究分野での数理情報リテラシとして，
大きく次の点についてお話しします。

[[file:../Maps/数理情報科学のための情報計算リテラシー.xmind]]
[[shell:xmind :../Maps/数理情報科学のための情報計算リテラシー.xmind]]
...
[[../Maps/知的思考の7段階.xmind][知的思考の7段階(file)]] [[shell:xmind ../Maps/知的思考の7段階.xmind][xmind_open]]
...
*** 理解の記録(外化，メモや文書)
思考の目的は理解すること
- わかるとは [[../Maps/わかるとは.xmind]][わかるとは.xmind]]  [[shell:xmind ../Maps/わかるとは.xmind][xmind-open]]
