...
* あらすじ -- 数理情報科学研究のための数理情報リテラシー [[file:../Maps/数理情報科学のための情報計算リテラシー.xmind][link]] [[shell:open ../Maps/数理情報科学のための情報計算リテラシー.xmind][cmd]]

[[[../Maps/数理情報科学のための情報計算リテラシー.xmind][Mindmap書類]]][[[shell::open ../Maps/数理情報科学のための情報計算リテラシー.xmind][アプリ]]]
...
情報計算の基盤について概観 (添付の mindmap 図) します。[[[../Maps/ICTの利用目的.xmind][Mindmap書類]]][[[shell:open ../Maps/ICTの利用目
的.xmind][Xmindアプリ]]]
...
** わかるとは
[[../Maps/わかるとは.xmind][わかるとは(file)]] または
[[shell:open ../Maps/わかるとは.xmind][わかるとは (xmind-open)]]
参照
...
[[../Maps/知的思考の7段階.xmind][知的思考の7段階(file)]] [[shell:open ../Maps/知的思考の7段階.xmind][xmind_open]]
...
*** 理解の記録(外化，メモや文書)
思考の目的は理解すること
- わかるとは [[../Maps/わかるとは.xmind]][わかるとは.xmind]]  [[shell:open ../Maps/わかるとは.xmind][xmind-open]]
