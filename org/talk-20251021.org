...
#+title: 数理情報科学研究のための数理情報リテラシー

- 講義内容の [[https://github.com/masayuki054/comp_and_cal/][GitHub リポジトリ]] [リンク]
- 講義内容 [[https://github.com/masayuki054/comp_and_cal/blob/master/org/talk-20251021.org][talk-20251021.org]] [リンク]

* あらすじ -- 数理情報科学研究のための数理情報リテラシー 

[[[../Maps/数理情報科学のための情報計算リテラシー.xmind][Mindmap書類]]][[[shell:xmind ../Maps/数理情報科学のための情報計算リテラシー.xmind][アプリ]]]

#+ATTR_LATEX: :width 18cm 
[[../Figs/infocalc-literacy-for-mathinfosci.png]]
# [[../Maps/数理情報科学のための情報計算リテラシー.png]]
...
- [[../Maps/ICTの利用目的.xmind][Mindmap書類]]
- [[shell:xmind ../Maps/ICTの利用目的.xmind][Xmindアプリ]]]
...
* 知的思考の技術
** 思考の基本
- 分類 [googling AIモード 思考 分類 抽象化]

- 抽象化 [googling AIモード 思考 抽象化 帰納]
  ある関係性で複数の事柄をまとめ，適切な名前を付けること
  
- 詳細化 [googling AIモード 思考 詳細化  具体化]
  抽象化の逆。記号の意味を示すこと。
...
[[https://www.chikumashobo.co.jp/product/9784480059390/][『「わかる」とはどういうことか』山鳥 重 | 筑摩書房 ]]
の読書ノート参照
- [[../Maps/わかるとは.xmind][わかるとは (file-open)]] または
- [[shell:xmind ../Maps/わかるとは.xmind][わかるとは (xmind-open)]]
...
のまとめ mindmap：
- [[../Maps/知的思考の7段階.xmind][知的思考の7段階(file)]] または
- [[shell:open ../Maps/知的思考の7段階.xmind][xmind_open]]
...
** プロセス管理手法
- GTD Getting Things Done (後述)
- [[[[./topics/comp_thinking.org]]][計算論的思考]] (後述)
...
- 思考は情報処理プロセス
- メタ思考が重要 (思考する自分を客観視すること)
  - 思考プロセスの見える化
  - 知的思考の *技術* がある

** 考える，記憶する，理解する，こととは？
*** 思考の基本 抽象化と詳細化, So What, Why so, MECE (mutually
  exclusive collectively exhaustive)
  [googling AIモード 思考 So What, Why so]
  [[elisp:google-this "AIの思考ステップ")]]

*** 思考の記録 MECE, 構造化，GTD
[googling 思考の記録 構造化 GTD]

*** いろいろな思考法がある
- 論理的思考  [[elisp:(google-this "思考" "論理的思考")]] へんな回答がかえって
  きた
  [[elisp:(google-this "思考と論理的思考とAI")]]
  
- 批判的思考 [googling 思考 批判的思考]
- 発想法 [googling 思考 発想法]
- 水平思考 [googling 思考 水平思考]
- 計算論的思考[googling 思考 計算論的思考]
...
思考の目的は理解すること
- わかるとは.xmindの参照
  - [[../Maps/わかるとは.xmind][わかるとは.xmind]]|[[shell:xmind  ../Maps/わかるとは.xmind][xmind-open]]
...
- [GTD (Getting Things Done) プロセス管理法] googling 
  - Todo リストの作り方と管理方法 
X  - [[https://masayuki054.github.io/cloud_and_information_literacy/i_maps/%E5%83%95%E3%81%AB%E3%81%A8%E3%81%A3%E3%81%A6%E3%81%AEGTD_imap.pdf][僕にとってのGTD_imap.pdf]]
  - ストレスフリーなプロセス管理 すべて忘れても思い出せる
- [[./topics/9つのストレス対処法.org]]

* 思考の数学的理解
[[https://github.com/masayuki054/mathematics/tree/main][GitHub - masayuki054/mathematics: 岩手大学講義 数理のひろがりのためのリポジトリ]]

** 数学は言葉である
[[../Maps/数理のひろがり.xmind]] | [[shell:xmind ../Maps/数理のひろがり.xmind]]
- 数学基礎論
- 集合と構造 情報
- 集合と関数 手続きと抽象化
- 集合と関係 分類と構造
...
[[file:./docs/diff-descrete.pdf][2024年度の手書きの資料]]
...
#+ATTR_LATEX: :width 18cm
[[../Figs/Web-revolution.png]]

#+caption: 思考とメモと文書のためのデジタル・ツール
#+ATTR_LATEX: :width 18cm
[[../Figs/ict-tools-for-thinking-and-memo.png]]
