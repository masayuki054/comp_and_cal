...
*** いろいろな思考法がある
- 論理的思考  [googling AIモード 思考 論理的思考] へんな回答がかえって
  きた
  [googling 思考 論理的思考] 
...
*** 理解の記録(外化，メモや文書)
思考の目的は理解すること
- わかるとは 参照 [[../Maps/わかるとは.xmind][わかるとは.xmind]]|[[shell:xmind  ../Maps/わかるとは.xmind][xmind-open]]
...
たとえば，[[file:topics/宇宙がわかる17の方程式.org][宇宙がわかる17の方
程式]] で記述される現象を解析する。
