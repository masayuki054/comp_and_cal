...
* 数式処理アルゴリズム
** 規則と簡約化と検索のための計算機代数
高次多変数代数方程式の解法についての解説: [[./gbasis/gbasis.org]]

グレブナー基底に関する用語とブッフバーガー算法については下記を参照します: 
...
*** 解説資料へのリンク:
- [[./gbasis/reduction_and_matrix.org][グレブナー基底と線形代数(org)]]
- [[./gbasis/reduction_and_matrix.pdf][グレブナー基底と線形代数(pdf)]]
