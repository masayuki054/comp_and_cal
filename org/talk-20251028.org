...
- [[shell:evince ./docs/diff-descrete.pdf][./docs/diff-descrete.pdf)] (昨年度の板書)
- [[shell:evince ./docs/diagrams_of_diff-v3.pdf][./docs/diagrams_of_diff-v3.pdf]] (2025-補足)
...
- [[shell:evince ./gbasis/presen.pdf][グレブナー基底と高次多変数方程式の解法(pdf)]]
...
- [[shell:evince ./gbasis/reduction_and_matrix.pdf]]
*** ガウスの消去法による線形方程式の解法
**** 連立一次方程式と行列表現
**** ガウスの消去法
...
- 微分方程式 -  微分作用素が作る微分作用素環
  - [[shell:xdg-open ./refers/D-module_and_comp_math-index.pdf]]
